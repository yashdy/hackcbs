                            ...
                            return (
                                <div className="flex flex-col" key={item.name}>
                                    <div className='bg-black'>
                                        <a
                                            href="#"
                                            className="flex flex-col items-center bg-black rounded-lg shadow md:flex-row md:max-w-xl hover:bg-gray-100 dark:border-gray-700 dark:bg-gray-800 dark:hover:bg-gray-700"
                                        >
                                            <img
                                    ...
                                    <div className="bg-black mt-5">
                                        <div className="bg-black block max-w-sm p-6 border rounded-lg shadow hover:bg-gray-100 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700">
